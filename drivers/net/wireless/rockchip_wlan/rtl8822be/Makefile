...
CONFIG_RTW_IP_REACHABILITY_PATCH = y
########################## Debug ###########################
CONFIG_RTW_DEBUG = y
...
ifeq ($(CONFIG_RTW_IP_REACHABILITY_PATCH), y)
EXTRA_CFLAGS += -DRTW_IP_REACHABILITY_PATCH
endif
...
obj-$(CONFIG_RTL8822BE) := $(MODULE_NAME).o

else

export CONFIG_RTL8822BE = m
